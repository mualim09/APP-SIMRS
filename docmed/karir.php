...
<body>
	...
	<div class="bradcam_area breadcam_bg" style="background-image: url('assets/img/bg-pelayanan/bg-karir.png'); background-size: 100%; background-position: 50% 50%;">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					<div class="bradcam_text">
						<h3>Karir</h3>
						<p><a href="index.php">Beranda </a>/ Karir</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12 posts-list">
				<div class="blog_details">
					...
					<p align="justify">Rekrutmen Lowongan Kerja Rumah Sakit Khusus Ginjal NY. R.A. Habibie.</p>
				</div>
			</div>
		</div>
