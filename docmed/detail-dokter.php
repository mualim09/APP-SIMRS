			...
			<div class="row">
				<div class="col-xl-12">
					<div class="bradcam_text">
						<h3>Detail Dokter</h3>
						<p><a href="index.php">Beranda</a>/Detail Dokter</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-2 posts-list">
				<div class="section-top-border">
					...
					$result = mysqli_query($con,"SELECT * FROM tb_dokter WHERE id_dokter='1' ORDER BY id_dokter ASC");
					...
					if(mysqli_num_rows($result)>0){
						while($row = mysqli_fetch_array($result))
						{
							...
							if ($row['foto']==NULL){
								echo "<td>";
								echo "<img src='assets/img/dokter/no-foto/blank.jpg' width='170px'>";
								echo "</td>";
							}else{
								echo "<td>";
								echo "<img src='assets/img/dokter/crop/$row[foto]' width='170px'>";
								echo "</td>";
							}
							echo "</tr>";
					...
					if(mysqli_num_rows($result)>0){
						while($row = mysqli_fetch_array($result))
						{
							...
							if ($row['nama_dokter']==NULL){
								...
								echo "<td><strong>".$row['nama_dokter'] . "</strong></td>";
							}
							echo "<br><br>";
