			...
			<div class="row">
				<div class="col-xl-12">
					<div class="bradcam_text">
						<h3>Galeri Kami</h3>
						<p><a href="index.php">Beranda </a>/ Galeri Kami</p>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-xl-12">
							<ul class="nav" id="myTab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="Fasilitas-tab" data-toggle="tab" href="#Fasilitas" role="tab" aria-controls="Fasilitas"
								...
								<div class="container box_1170">
									<div class="section">
										<div class="row gallery-item">
											...
											<div class="col-md-4">
												<a href="assets/img/gallery/g6.png" class="img-pop-up">
													<div class="single-gallery-image" style="background: url(assets/img/gallery/g6.png);"></div>
												</a>
											</div>
											<div class="col-md-4">
												<a href="assets/img/gallery/g7.png" class="img-pop-up">
													<div class="single-gallery-image" style="background: url(assets/img/gallery/g7.png);"></div>
												</a>
											</div>
											<div class="col-md-4">
												<a href="assets/img/gallery/g8.png" class="img-pop-up">
													<div class="single-gallery-image" style="background: url(assets/img/gallery/g8.png);"></div>
												</a>
											</div>
										</div>
									</div>
