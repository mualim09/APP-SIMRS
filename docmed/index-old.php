...
<body>
    ...
    <!-- Rs. Khusus Ny. Habibie -->
    <!-- <div class="our_department_area">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-55">
                        <h3>Rumah Sakit Khusus Ginjal Ny. R.A. Habibie</h3>
                        <p align="justify-content-center">Kami menyediakan pelayanan kesehatan yang didukung oleh para spesialis di berbagai bidang antara lain spesialis Ginjal dan Hipertensi, Spesialis Penyakit dalam dan paru, spesialis bedah vaskuler, spesialis gigi dan bedah mulut, spesialis anestesi, spesialis urologi, spesialis radiologi, dan lain-lain. Kami memiliki pengalaman yang diperlukan untuk mengelola pelayanan kesehatan bermutu tinggi secara profesional dan kekeluargaan namun dengan harga terjangkau.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="assets/img/department/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="assets/img/department/2.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="assets/img/department/3.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="assets/img/department/4.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="assets/img/department/5.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="assets/img/department/6.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                                    <img src="media/img/department/1.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    <h3>A <br> scaler near patient</h3 >
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                                    <a href="#" class="boxed-btn">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    <h3>B <br> scaler near patient</h3 >
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                                    <a href="#" class="boxed-btn">Selengkapnya</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    <h3>C <br> scaler near patient</h3 >
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                                    <a href="#" class="boxed-btn">Selengkapnya</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="Astrology" role="tabpanel" aria-labelledby="Astrology-tab">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    <h3>D <br> scaler near patient</h3 >
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                                    <a href="#" class="boxed-btn">Selengkapnya</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="Neuroanatomy" role="tabpanel" aria-labelledby="Neuroanatomy-tab">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    <h3>E <br> scaler near patient</h3 >
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                                    <a href="#" class="boxed-btn">Selengkapnya</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="Blood" role="tabpanel" aria-labelledby="Blood-tab">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    <h3>F <br> scaler near patient</h3 >
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                                    <a href="#" class="boxed-btn">Selengkapnya</a>
                                </div>
                            </div>
                    ...
                    <div class="expert_active owl-carousel">
                        <div class="single_expert">
                            ...
                            <div class="experts_name text-center">
                                <h3>Dr ESTHER SYLVIANI SUTEDJO</h3>
                        ...
                        <div class="single_expert">
                            ...
                            <div class="experts_name text-center">
                                <h3>Dr IRENE RANNY KRISTYA N, MH.Kes</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <!-- <div class="single_expert">
                        ...
                        <div class="single_expert">
                            ...
                            <div class="experts_name text-center">
                                <h3>Dr MELITA HENDRIANI, MMRS</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/7.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Dr NIA SYLVIANI</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/8.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>dr. ADE ASTRIDA</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/9.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Dr. NANDYA MEITADANI</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            ...
                            <div class="experts_name text-center">
                                <h3>dr. RANY RAMADHAN KUSUMA SEJATI</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/11.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>dr YOVAN RIVANZAH</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/12.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>drg. R. YULIA PUSPITASARI</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/13.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>dr. VERA DIANWARI</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/14.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>dr. DHIA RAMADHANI</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="assets/img/dokter/crop/15.png">
                            </div>
                            <div class="experts_name text-center">
                                <h3>dr. RATIH YONARITA NASUTION</h3>
                                <span>Selengkapnya</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="business_thumb">
                                    <img src="assets/img/about/business.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6">
                    <div class="single_emergency d-flex align-items-center justify-content-center emergency_bg_1 overlay_skyblue">
                        ...
                        <div class="info_button">
                            <a href="#" class="boxed-btn3-white">+00 000 4673 467</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
