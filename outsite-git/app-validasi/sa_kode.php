...
{    
  ...
  $query = mysql_query("INSERT INTO tb_kode 
    ...
    ");
  if ($query) {
    header("Location: ./sa_kode.php?ntf=1");  
  } else {
    header("Location: ./sa_kode.php?ntf=6");
  }
}
...
{    
  ...
  if($query){
    header("Location: ./sa_kode.php?ntf=4");                                                  
  } else {
...
if(isset($_POST['deletekode']))
{
  ...
  if($id_kode){
    ...
    if($query){
     header("Location: ./sa_kode.php?ntf=3");                     
   } else {
    header("Location: ./sa_kode.php?ntf=6");  
  }
} else {
...
<head>
    ...
    <title>ITicket | Kode Bagian/Instalasi/Komite</title>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Kode Bagian/Instalasi/Komite</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Kode Bagian/Instalasi/Komite</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="id_sing">
                                <input type="hidden" class="form-control" name="date_sing" value="<?php echo date('Y-m-d'); ?>">
                              </div>
                            </div>
                          </div>
                        </div>
