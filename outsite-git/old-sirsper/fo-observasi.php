            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="form-element-list mg-t-30">
                ...
                <div class="row" align="center">
                  ...
                  <div class="col-lg-4">
                    <div class="nk-int-mk">
                      <label>No. Periode<font style="color: red">*</font></label>
                    </div>
                    <div class="form-group ic-cmp-int">
                      <div class="nk-int-st">
                        <input type="text" class="form-control" name="no_periode" required="required" placeholder="No. Periode">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="nk-int-mk">
                      <label>No. Sesi<font style="color: red">*</font></label>
                    </div>
                    <div class="form-group ic-cmp-int">
                      <div class="nk-int-st">
                        <input type="text" class="form-control" name="no_sesi" required="required" placeholder="No. Sesi">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row" align="center">
                  <div class="col-lg-4">
                    ...
                    <div class="form-group ic-cmp-int">
                      <div class="nk-int-st">
                        <input type="text" class="form-control" name="pelayanan" placeholder="Pelayanan">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="nk-int-mk">
                      <label>Tgl <font style="font-size: 10px">(Hari/Bulan/Tahun)</font></label>
                    </div>
                    <div class="form-group ic-cmp-int">
                      <div class="nk-int-st">
                  ...
                  <div class="col-lg-4">
                    <div class="nk-int-mk">
                      <label>Observer <font style="font-size: 10px">(Inisial)</font></label>
                    </div>
                    <div class="form-group ic-cmp-int">
                      <div class="nk-int-st">
                        <input type="text" class="form-control" name="observer" placeholder="Observer">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row" align="center">
                  <div class="col-lg-4">
                    ...
                    <div class="form-group ic-cmp-int form-elet-mg res-mg-fcs">
                      <div class="nk-int-st">
                        <input type="text" class="form-control" name="bangsal" placeholder="Bangsal">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="nk-int-mk">
                      <label>Mulai/Selesai Waktu</label>
                    </div>
                    <div class="form-group ic-cmp-int form-elet-mg res-mg-fcs">
                      <div class="nk-int-st">
                  ...
                  <div class="col-lg-4">
                    <div class="nk-int-mk">
                      <label>No. Hal<font style="color: red">*</font></label>
                    </div>
                    <div class="form-group ic-cmp-int form-elet-mg">
                      <div class="nk-int-st">
                        <input type="text" class="form-control" data-mask="999 999 999 9999" placeholder="No. Hal">
                      </div>
                    </div>
                  </div>
                </div>
