...
if ($ntf == 1) {
	...
	<div class="alert alert-success alert-dismissable">
		...
		<small>Hai, <?php echo $access['fullname']; ?></label>
...
// CODE 2 : FOR DUPLICATE RECORD
	...
	<div class="alert alert-warning alert-dismissable">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
		<small>Hai, <?php echo $access['fullname']; ?></small>
...
// CODE 4 : RECORD HAS BEEN UPDATED
	...
	<div class="alert alert-success alert-dismissible" role="alert">
		...
		</button> Hai, <a href="" class="alert-link"><?php echo $access['fullname']; ?></a>.
		<br>
		Selamat Datang di Sistem Informasi PPI RS. Khusus Ginjal Ny. R.A. Habibie. Enjoyed!
	</div>
	<?php
}
?>
