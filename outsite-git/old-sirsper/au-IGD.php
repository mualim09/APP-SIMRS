              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="breadcomb-wp">
                  ...
                  <div class="breadcomb-ctn">
                    <h2>Form Audit Instalasi Gawat Darurat</h2>
                    <p>Dashboard / Instalasi Gawat Darurat</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form action="" method="POST">
                <div class="bsc-tbl-bdr">
                  <table class="table table-striped">
                    <tbody>
                      <tr>
                        ...
                        <td colspan="4" align="center">
                          <p>
                            ...
                            <input type="hidden" class="form-control" name="ruangan" value="Instalasi Gawat Darurat">
                      ...
                      <tr>
                        <td colspan="6" align="center" style="background-color: #00c292; color: #ffff">
                          <p><h3>Monitoring/ Audit PPI di Ruang Instalasi Gawat Darurat</h3></p>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Brankar dalam keadaan bersih</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Lantai tidak licin dan bersih</p>
                      </td>
                      <td>
