...
{    
  ...
  $query = mysql_query("INSERT INTO tb_client 
    ...
    ");
  if ($query) {
    header("Location: ./kasir-laporan.php?ntf=1");  
  } else {
    header("Location: ./kasir-laporan.php?ntf=6");
  }
}
...
{    
  ...
  if($query){
    header("Location: ./kasir-laporan.php?ntf=4");                                                  
  } else {
...
{    
  ...
  move_uploaded_file($file_tmp, './assets/file/kasir-laporan//'.$nama);
  
  $query = mysql_query("UPDATE tb_client SET 
    _ani = '$nama'
    WHERE id_client ='$id_client'");
  if($query){
    header("Location: ./kasir-laporan.php?ntf=5");                                                  
  } else {
    header("Location: ./kasir-laporan.php?ntf=6");  
  }
} 
...
if(isset($_POST['delete']))
{
  ...
  if($id_client){
    ...
    if($query){
     header("Location: ./kasir-laporan.php?ntf=3");                     
   } else {
    header("Location: ./kasir-laporan.php?ntf=6");  
  }
} else {
      ...
      <section class="content">
        <div class="container-fluid">
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <label class="modal-title">Tambah Laporan Transaksi</label>
          ...
          <div class="card">
            <div class="card-header">
              <div align="right">
                <a href="cetak-kasir-laporan.php" target="_blank">
                  <span type="submit" name="search" value="search" class="btn bg-gray btn-flat">
                    <i class="fa fa-print"></i> 
                    Print
                  </span>
                </a>
                <a href="assets/file/telepon_keluar/download/ex_kasir-laporan.php">
                      ...
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        <div class="modal fade" id="edit<?php echo $row['id_client'];?>">
                          <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title">Update Laporan Transaksi</label>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                        ...
                        <div class="modal fade" id="delete<?php echo $row['id_client'];?>" role="dialog">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title">Delete Laporan Transaksi</label>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                <form method="post" action="">
                                  <div class="form-group">
                                    <label>Hapus Data Laporan Transaksi?</label>
