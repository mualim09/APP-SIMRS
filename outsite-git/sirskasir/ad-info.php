...
{    
  ...
  $query = mysql_query("INSERT INTO tb_client 
    ...
    ");
  if ($query) {
    header("Location: ./ad-info.php?ntf=1");  
  } else {
    header("Location: ./ad-info.php?ntf=6");
  }
}
...
{    
  ...
  if($query){
    header("Location: ./ad-info.php?ntf=4");                                                  
  } else {
...
{    
  ...
  move_uploaded_file($file_tmp, './assets/file/ad-info//'.$nama);
  
  $query = mysql_query("UPDATE tb_client SET 
    _ani = '$nama'
    WHERE id_client ='$id_client'");
  if($query){
    header("Location: ./ad-info.php?ntf=5");                                                  
  } else {
    header("Location: ./ad-info.php?ntf=6");  
  }
} 
...
if(isset($_POST['delete']))
{
  ...
  if($id_client){
    ...
    if($query){
     header("Location: ./ad-info.php?ntf=3");                     
   } else {
    header("Location: ./ad-info.php?ntf=6");  
  }
} else {
      ...
      <section class="content">
        <div class="container-fluid">
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <label class="modal-title">Tambah Info</label>
          ...
          <div class="card">
            <div class="card-header">
              <div align="right">
                <a href="cetak-ad-info.php" target="_blank">
                  <span type="submit" name="search" value="search" class="btn bg-gray btn-flat">
                    <i class="fa fa-print"></i> 
                    Print
                  </span>
                </a>
                <a href="assets/file/telepon_keluar/download/ex_ad-info.php">
                      ...
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        <div class="modal fade" id="edit<?php echo $row['id_client'];?>">
                          <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title">Update Info</label>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                        ...
                        <div class="modal fade" id="delete<?php echo $row['id_client'];?>" role="dialog">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title">Delete Info</label>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
