...
<head>
  ...
  <title>SIRS KASIR</title>
  <link rel="shortcut icon" type="image/png" href="assets/images/icon/logo3.png">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
       <div class="card-body" style="background-color: #ffffff">
        <div align="center">
          <img src="assets/img/all-rs/rskg2.png" width="200px">
        </div>
      </div>
      <hr>
      <div class="card-body" style="background-color: #ffffff">
        <div align="center">
          <h1><b>APLIKASI KWITANSI KASIR</b></h1>
          <hr>
