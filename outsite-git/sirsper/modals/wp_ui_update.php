                    ...
                    <form method="post" action="">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="dashboard" required>
                          ...
                          <option value="Struktur" <?= !empty($row_tema_3['dashboard']) && $row_tema_3['dashboard'] == 'Struktur' ? 'selected' : '' ?>>Struktur</option>
                          <option value="Asumsi & Penentuan Limit" <?= !empty($row_tema_3['dashboard']) && $row_tema_3['dashboard'] == 'Asumsi & Penentuan Limit' ? 'selected' : '' ?>>Asumsi & Penentuan Limit</option>
                          <option value="Analisa Risiko & Mitigasi" <?= !empty($row_tema_3['dashboard']) && $row_tema_3['dashboard'] == 'Analisa Risiko & Mitigasi' ? 'selected' : '' ?>>Analisa Risiko & Mitigasi</option>
                          <option value="Performance Lap Keu" <?= !empty($row_tema_3['dashboard']) && $row_tema_3['dashboard'] == 'Performance Lap Keu' ? 'selected' : '' ?>>Performance Lap Keu</option>
                          <option value="Kesesuaian ketentuan & syarat" <?= !empty($row_tema_3['dashboard']) && $row_tema_3['dashboard'] == 'Kesesuaian ketentuan & syarat' ? 'selected' : '' ?>>Kesesuaian ketentuan & syarat</option>
                        </select>
                      </div>
                      <div class="form-group">
