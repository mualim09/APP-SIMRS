...
{    
  ...
  $peru_diubah_menjadi  = $_POST['peru_diubah_menjadi'];
  ...
  $query = mysql_query("INSERT INTO tb_ppd 
    (id_peru,kode,pemohon,bagian,tanggal,date_ppd,peru_dokumen,peru_judul,peru_no_dok,peru_tgl_berlaku,peru_status_revisi,peru_bagian_revisi,peru_diubah_menjadi,peru_alasan,username,dokumen,status_pengecekan,upload_lam)
    VALUES 
    ('','$kode','$pemohon','$bagian','$tanggal','$date_ppd','$peru_dokumen','$peru_judul','$peru_no_dok','$peru_tgl_berlaku','$peru_status_revisi','$peru_bagian_revisi','$peru_diubah_menjadi','$peru_alasan','$username','$dokumen','$status_pengecekan','$nama')
    "); 

  $query = mysql_query("INSERT INTO tb_ppd_his
    (id_his,his_id_peru,his_kode,his_pemohon,his_bagian,his_tanggal,his_date_ppd,his_peru_dokumen,his_peru_judul,his_peru_no_dok,his_peru_tgl_berlaku,his_peru_status_revisi,his_peru_bagian_revisi,his_peru_diubah_menjadi,his_peru_alasan,his_username,his_dokumen,his_status_pengecekan,his_upload_lam)
    VALUES 
    ('','$id_peru','$kode','$pemohon','$bagian','$tanggal','$date_ppd','$peru_dokumen','$peru_judul','$peru_no_dok','$peru_tgl_berlaku','$peru_status_revisi','$peru_bagian_revisi','$peru_diubah_menjadi','$peru_alasan','$username','$dokumen','$status_pengecekan','$nama')
    "); 
...
{    
  ...
  $query = mysql_query("UPDATE tb_ppd SET 
    ...
    peru_diubah_menjadi = '$peru_diubah_menjadi',
  ...
  $query .= mysql_query("UPDATE tb_ppd_his SET 
    ...
    his_peru_diubah_menjadi = '$peru_diubah_menjadi',
        ...
        <div class="modal-dialog modal-xl">
         ...
         <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <label>Diubah Menjadi<font style="color: red">*</font></label>
                <textarea class="ckeditor" id="ckedtor" name="peru_diubah_menjadi" placeholder="Diubah Menjadi ..." required="required"></textarea>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
              ...
              if(mysqli_num_rows($result)>0){
                while($row = mysqli_fetch_array($result))
                {
                  ...
                  if ($row['status_pengecekan']=='New') {
                    ...
                    echo "<td>
                    <a href='sis_tampilan_revisi_perubahan.php?id=$row[id_peru]' target=_blank title='Revisi'><button class='btn btn-dark btn-sm'>Revisi</button></a>
                    </td>";                                                      
                  }elseif ($row['status_pengecekan']=='Disetujui') {
                    echo "<td>
                    <a href='sis_tampilan_revisi_perubahan.php?id=$row[id_peru]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'><i class='fa fas fa-check' title='Disetujui'></i></button></a>
                    </td>";    
                  }
                  ...
                  echo "<td align='center'>
                  <a href='./assets/file/perubahan/admin/$row[file_result]' target='_blank'><img src='assets/images/icon/file.png' width='40px'></a>
                  </td>";
                }
                if ($row['file_result']==NULL) {
                  echo "<td>
                  ...
                  <a href='#' data-toggle='modal' data-target='#delete$row[id_peru]' title='Hapus Perubahan Dokumen'><span class='badge badge-dark'><i class='fa fas fa-times'></i> </span></a>
                  </td>";
                }else{
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <h5><b>Status Revisi :</b> <?php echo $row['peru_status_revisi'];?></h5>
                ...
                <div class="modal fade" id="edit<?php echo $row['id_peru'];?>" role="dialog">
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">Update Perubahan Dokumen</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <form action="" method="POST">
                        <div class="modal-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                <label>Diubah Menjadi</label>
                                <textarea class="ckeditor" id="ckedtor" name="peru_diubah_menjadi" placeholder="Diubah Menjadi ..." required="required"><?php echo $row['peru_diubah_menjadi']; ?></textarea>
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="form-group">
                ...
                <div class="modal fade" id="delete<?php echo $row['id_peru'];?>" role="dialog">
                  ...
                  <div class="modal fade" id="addfile<?php echo $row['id_peru'];?>" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title">Upload File Akhir</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
