...
<head>
  ...
  <title>SIMDO | History Perubahan Dokumen</title>
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">History Perubahan Dokumen</h2>
            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php?ntf=0" class="breadcrumb-link">History</a></li>
                  <li class="breadcrumb-item active" aria-current="page">History Perubahan Dokumen</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <div class="card-header">
              <label>History Perubahan Dokumen</label>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered second" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_ppd_his WHERE his_dokumen='Perubahan' ORDER BY id_his DESC");
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        if ($row['his_status_pengecekan']=='New') {
                          ...
                          echo "<td>
                          <a href='sis_tampilan_revisi_perubahan_publish.php?id=$row[id_his]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'>Revisi</button></a>
                          </td>";                                                      
                        }elseif ($row['his_status_pengecekan']=='Disetujui') {
                          echo "<td>
                          <a href='sis_tampilan_revisi_perubahan_publish.php?id=$row[id_his]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'><i class='fa fas fa-check' title='Disetujui'></i></button></a>
                          </td>";    
                        }
                        echo "<td>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        ...
                                        <h5><b>Dokumen :</b> <?php echo $row['his_peru_dokumen'];?></h5>
                                        <h5><b>Judul :</b> <?php echo $row['his_peru_judul'];?></h5>
                                        <h5><b>No. Dokumen :</b> 
                                          <?php
                                          if ($row['his_peru_no_dok']==NULL) {
                                            echo "<i>Belum Memiliki No. Dokumen</i>";
                                          }
                                          echo $row['his_peru_no_dok'];
                                          ?>
                                        </h5>
                                        <h5><b>Tanggal Berlaku :</b> 
                                          <?php
                                          if ($row['his_peru_tgl_berlaku']==NULL) {
                                            echo "<i>Belum Memiliki Tanggal Berlaku</i>";
                                          }
                                          echo $row['his_peru_tgl_berlaku'];
                                          ?>
                                        </h5>
                                        <hr>
                                        <div align="center">
                                        ...
                                        if ($row['his_upload_lam']==NULL){
                                          ...
                                          echo "
                                          <div align='center'>
                                          <a href='./assets/file/perubahan/user/$row[his_upload_lam]' target='_blank'><img src='assets/images/icon/file.png' width='90px'></a>
                                          </div>
                                          ";
                                        }
                                        ?>
                                        ...
                                        if ($row['his_upload_lam']==NULL){
                                          ...
                                          echo "
                                          <div align='center'>
                                          <a href='./assets/file/perubahan/user/$row[his_file_result]' target='_blank'><img src='assets/images/icon/file.png' width='90px'></a>
                                          </div>
                                          ";
                                        }
                                        ?>
                                      </div>
                                      <h5><b>Status Revisi :</b> <?php echo $row['his_peru_status_revisi'];?></h5>
                                      <h5><b>Bagian Yang Diubah :</b></h5>
                                      <br>
                                      <textarea class="ckeditor" id="ckedtor" readonly="readonly"><?php echo $row['his_peru_bagian_revisi']; ?></textarea>
                                      <h5><b>Diubah Menjadi :</b></h5>
                                      <br>
                                      <textarea class="ckeditor" id="ckedtor" readonly="readonly"><?php echo $row['his_peru_diubah_menjadi']; ?></textarea>
                                      <h5><b>Alasan Perubahan :</b></h5>
                                      <br>
                                      <textarea class="form-control" readonly="readonly"><?php echo $row['his_peru_alasan']; ?></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-sm-12">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="peru_no_dok" placeholder="No. Dokumen ..." value="<?php echo $row['his_peru_no_dok']; ?>">
                                      </div>
                                    </div>
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        <label>Tanggal Berlaku</label>
                                        <input type="date" class="form-control" name="peru_tgl_berlaku" value="<?php echo $row['his_peru_tgl_berlaku']; ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="modal-body">
                                <form method="post" action="">
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" name="peru_dokumen" class="form-control" value="<?php echo $row['his_peru_dokumen'];?>" required>
                                    <input type="hidden" name="peru_judul" class="form-control" value="<?php echo $row['his_peru_judul'];?>" required>
