...
{    
  ...
  move_uploaded_file($file_tmp, './assets/file/pembuatan/admin/revisi/'.$nama);
  ...
  if($query){
    header("Location: ./sis_tampilan_revisi_pembuatan.php?id=$id_peru");                                                  
  } else {
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                ?>
                                <div align="center">
                                    <h5>Diupload Tanggal : <?php echo $row['date_ppd'];?></h5>
                                </div>
                            </div>
                        </div>
                        <?php } }  mysqli_close($con); ?>
                            ...
                            <?php
                                    ...
                                    echo "
                                     <div class='form-group'>
                                        ...
                                        <a href='./assets/file/pembuatan/admin/revisi/$row[file_revisi]' target='_blank'><img src='assets/images/icon/file.png' width='90px'></a>
                                    </div>
                                    ";
                                }
