              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-inline-block">
                    ...
                    $result = mysqli_query($con,"SELECT COUNT(*) AS total_sw FROM tb_ppd WHERE dokumen='Pembuatan'");
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-inline-block">
                      ...
                      $datax = $_SESSION['username'];
                      $result = mysqli_query($con,"SELECT COUNT(*) AS total_hw FROM tb_ppd WHERE dokumen='Perubahan'");
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-inline-block">
                        ...
                        $datax = $_SESSION['username'];
                        $result = mysqli_query($con,"SELECT COUNT(*) AS total_pt FROM tb_ppd WHERE dokumen='Nonaktif'");
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-inline-block">
                          ...
                          $datax = $_SESSION['username'];
                          $result = mysqli_query($con,"SELECT COUNT(*) AS total_sw FROM tb_ppd WHERE dokumen='Pembuatan' AND publish='OK' ");
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="d-inline-block">
                            ...
                            $datax = $_SESSION['username'];
                            $result = mysqli_query($con,"SELECT COUNT(*) AS total_hw FROM tb_ppd WHERE dokumen='Perubahan' AND publish='OK'");
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="d-inline-block">
                              ...
                              $datax = $_SESSION['username'];
                              $result = mysqli_query($con,"SELECT COUNT(*) AS total_pt FROM tb_ppd WHERE dokumen='Nonaktif' AND publish='OK'");
