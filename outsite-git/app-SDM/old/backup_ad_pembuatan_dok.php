                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        if ($row['pem_no_dok']==NULL){
                          echo "<td>
                          <a href='#' data-toggle='modal' data-target='#updatenodok$row[id_peru]' title='Input No. Dokumen'><span class='btn btn-dark'><i class='fas fa-info'></i> Lengkapi </span></a>
                          </td>";
                        }else{
                          echo "<td>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" value="<?php echo $row['pem_tgl_berlaku']; ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                      ...
                      $result = mysqli_query($con,"SELECT a.id_peru,
                                                          a.date_ppd,
                                                          a.kode,
                                                          a.pemohon,
                                                          a.bagian,
                                                          ...
                                                          b.keterangan,
                                                          b.oleh
                                                          FROM tb_ppd a JOIN tb_revisi b
                                                          ON a.id_peru=b.id_peru");
