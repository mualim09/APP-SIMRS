              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="breadcomb-wp">
                  ...
                  <div class="breadcomb-ctn">
                    <h2>Form Audit Sterilisasi</h2>
                    <p>Dashboard / Sterilisasi</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form action="" method="POST">
                <div class="bsc-tbl-bdr">
                  <table class="table table-striped">
                    <tbody>
                      <tr>
                        ...
                        <td colspan="4" align="center">
                          <p>
                            ...
                            <input type="hidden" class="form-control" name="ruangan" value="Sterilisasi">
                      ...
                      <tr>
                        <td colspan="6" align="center" style="background-color: #00c292; color: #ffff">
                          <p><h3>Monitoring/ Audit PPI di Ruang Sterilisasi</h3></p>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Petugas tidak menggunakan perhiasan dan kuku pendek</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Lokasi area Dekontaminasi, pengemasan, sterilisasi, penyimpanan dan distribusi terpisah</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Fasilitas dan peralatan yang memadai untuk pembersihan, desinfeksi, dan pengeringan, pengemasan, dan sterilisasi tersedia</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Pintu keluar / masuk yang terpisah antara ruang bersih dan ruang kotor</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Terdapat dokumentasi monitoring suhu, kelembaban suhu, tekanan positif ( area bersih ), tekanan negatif ( area kotor ) dan pertukaran udara perjam</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Tersedia sarana cuci tangan </p>
                        </td>
                        <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Proses sterilisasi yang digunakan harus sudah tervalidasi dengan Biological test dan chemical indikator</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Penyimpanan alat habis pakai tidak boleh terlalu banyak dan harus dengan sistem FIFO</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Pengemasan linen dan instrument dilakukan terpisah</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Semua staf menggunakan seragam bersih dan APD yang sesuai dengan tindakan</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Trolley bersih dan kotor dibedakan</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Seluruh larutan kimia harus diberi label expire date</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Instrumen bedah didesinfeksi, dikeringkan, dan disusun dengan cara yang benar</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Instrumen dikemas dengan indicator tape pada bagian luar kemasan, dan tanggal expire dicetak dengan jelas dan sesuai</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Kemasan steril disimpan dalam ruang penyimpanan</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Ruang penerimaan, pengemasan, penyimpanan bebas debu, bersih dan rapih</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Trolley transport bersih dan tertutup</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Ada lembar monitoring perawatan mesin Autoclave</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Ada lembar inventaris alat – alat dan mesin </p>
                      </td>
                      <td>
