              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="breadcomb-wp">
                  ...
                  <div class="breadcomb-ctn">
                    <h2>Form Audit Kamar Bedah</h2>
                    <p>Dashboard / Kamar Bedah</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form action="" method="POST">
                <div class="bsc-tbl-bdr">
                  <table class="table table-striped">
                    <tbody>
                      <tr>
                        ...
                        <td colspan="4" align="center">
                          <p>
                            ...
                            <input type="hidden" class="form-control" name="ruangan" value="Kamar Bedah">
                      ...
                      <tr>
                        <td colspan="6" align="center" style="background-color: #00c292; color: #ffff">
                          <p><h3>Monitoring/ Audit PPI di Ruang Kamar Bedah</h3></p>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Menggunakan pakaian khusus OK</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td colspan="2">
                          <p>Menggunakan sepatu tertutup penuh dan dapat dicuci yang digunakan di OK</p>
                        </td>
                        <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Staff yang mengalami luka terbuka harus ditutup dengan dressing waterproof</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Menggunakan APD lengkap saat tindakan (penutup kepala, sarung tangan, masker, baju OK, sepatu)</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Cuci tangan bedah dengan benar</p>
                      </td>
                      <td>
                        <input type="radio" class="option-input radio" value="Yes" name="RI_22" name="example" />
                      </td>
                    ...
                    <tr>
                      <td colspan="6" style="background-color: #00c292;">
                        <p><strong>Kondisi Ruangan</strong></p>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <p>Pintu selalu tertutup</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Pertahankan tekanan selalu positif, suhu dan kelembaban beda dalam rentang di persyaratkan </p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Pembatasan jumlah orang di dalam kamar bedah</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Pembatasan akses masuk kamar bedah</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="6" style="background-color: #00c292;">
                        <p><strong>Pembuangan Sampah</strong></p>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <p>Penghasil limbah benda tajam harus langsung membuang</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Limbah benda tajam dibuang dalam safety box yang tahan air dan tahan tembus</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Safety box dibuang dalam kondisi terkunci (¾ penuh/sampai batas yang ada dalam box)</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Limbah infeksius di buang dikantong kuning</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Limbah rumah tangga di buang dikantong hitam</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Tumpahan darah segera dibersihkan dengan menggunakan spillkit</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="6" style="background-color: #00c292;">
                        <p><strong>Pembersihan Lingkungan</strong></p>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <p>Pembersihan antar pasien dilakukan dengan menggunakan larutan desinfektan untuk membersihkan lantai dan alat- alat lain</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Terdapat jadwal pembersihan harian dan mingguan</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Pembersihan dilakukan terhadap semua alat yang ada di dalam kamar bedah</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Hanya barang yang digunakan saja yang boleh berada di dalam kamar bedah</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Alat – alat dan alat habis pakai disimpan tidak boleh sejajar dengan lantai</p>
                      </td>
                      <td>
                        <input type="radio" class="option-input radio" value="Yes" name="RI_100" name="example" />
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Grill ventilasi tidak tersumbat dan tidak berdebu</p>
                      </td>
                      <td>
                        <input type="radio" class="option-input radio" value="Yes" name="RI_100" name="example" />
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Penyimpanan alat habis pakai tidak boleh terlalu banyak dan harus dengan System FIFO</p>
                      </td>
                      <td>
                        <input type="radio" class="option-input radio" value="Yes" name="RI_100" name="example" />
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Lantai, dinding, plafon, dan cat kamar bedah harus selalu dalam kondisi baik</p>
                      </td>
                      <td>
                        <input type="radio" class="option-input radio" value="Yes" name="RI_100" name="example" />
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Pemeriksaan kualitas udara dilakukan setiap 6 bulan dan jika ada perbaikan mayor, Pemeriksaan dilakukan dengan meletakkan agar plat dalam ruangan tertutup</p>
                      </td>
                      <td>
                        <input type="radio" class="option-input radio" value="Yes" name="RI_100" name="example" />
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <p>Tempat sampah infeksius menggunanakan kantong kuning</p>
                      </td>
                      <td>
