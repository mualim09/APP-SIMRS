                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="berkas_ani" placeholder="No Berkas ..." required="required">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>Nomor Intern<font style="color: red">*</font></label>
                          <input type="text" class="form-control" name="nomor_intern" placeholder="Nomor Intern ..." required="required">
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>Perihal<font style="color: red">*</font></label>
                          <input type="text" class="form-control" name="perihal_ani" placeholder="Perihal ..." required="required">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                  ...
                  <tbody>
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        <a href='#' data-toggle='modal' data-target='#edit$row[id_ani]' title='Edit'><span class='btn btn-warning btn-xs'><i class='fa fa-edit'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#delete$row[id_ani]' title='Delete'><span class='btn btn-danger btn-xs'><i class='fas fa-times'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#addfile$row[id_ani]' title='Tambah Lampiran'><span class='btn btn-default btn-xs'><i class='fas fa-file'></i> </span></a>
                        </td>";
                        echo "</tr>";
                        ?>
