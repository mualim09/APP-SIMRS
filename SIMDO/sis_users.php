...
<head>
  ...
  <title>SIMDO | Manage Users</title>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="user_role" style="width: 100%;">
                        ...
                        <option value="printer_task">Printer Task</option>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Email</label>
                      <input type="email" class="form-control" name="email" placeholder="Email@xyz.com ..." required="required">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <div class="card-header">
              <button class="btn btn-success btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Users"><i class="nav-icon far fa-plus-square"></i> Tambah Users
              </button>
            </div>
            <div class="card-body">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form method="post" action="">
                                  ...
                                  <button type="submit" name="delete" class="btn btn-dark btn-block btn-flat">Yes</button>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form method="post" action="" enctype="multipart/form-data">
                                  ...
                                  <button type="submit" name="uploadfoto" class="btn btn-dark btn-block btn-flat">Submit</button>
