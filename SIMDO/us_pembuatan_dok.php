...
{    
  ...
  move_uploaded_file($file_tmp, './assets/file/pembuatan/user/'.$nama);

  $query = mysql_query("INSERT INTO tb_ppd 
    (id_peru,kode,pemohon,bagian,tanggal,date_ppd,pem_dokumen,pem_judul,username,dokumen,status_pengecekan,upload_lam)
    VALUES 
    ('','$kode','$pemohon','$bagian','$tanggal','$date_ppd','$pem_dokumen','$pem_judul','$username','$dokumen','$status_pengecekan','$nama')
    "); 

  $query .= mysql_query("INSERT INTO tb_ppd_his 
    (id_his,his_id_peru,his_kode,his_pemohon,his_bagian,his_tanggal,his_date_ppd,his_pem_dokumen,his_pem_judul,his_username,his_dokumen,his_status_pengecekan,his_upload_lam)
    VALUES 
    ('','$id_peru','$kode','$pemohon','$bagian','$tanggal','$date_ppd','$pem_dokumen','$pem_judul','$username','$dokumen','$status_pengecekan','$nama')
    "); 
  if ($query) { header("Location: ./us_pembuatan_dok.php?ntf=1");   
} else {
  header("Location: ./us_pembuatan_dok.php?ntf=6"); 
} 
}
...
{    
  ...
  $query .= mysql_query("UPDATE tb_ppd_his SET 
    ...
    his_bagian = '$bagian',
    his_tanggal = '$tanggal',
    his_pem_dokumen = '$pem_dokumen',
    his_pem_judul = '$pem_judul'
    WHERE id_his ='$id_peru'");

  if($query){
    header("Location: ./us_pembuatan_dok.php?ntf=4");                                                  
  } else {
...
{    
  ...
  $query .= mysql_query("UPDATE tb_ppd_his SET 
    ...
    WHERE id_his = '$id_peru'");
  if($query){
    header("Location: ./us_pembuatan_dok.php?ntf=5");                                                  
  } else {
    header("Location: ./us_pembuatan_dok.php?ntf=6");  
  }
} 
...
{    
  ...
  $query .= mysql_query("UPDATE tb_ppd_his SET 
    ...
    WHERE id_his = '$id_peru'");
  if($query){
    header("Location: ./us_pembuatan_dok.php?ntf=3");                                                  
  } else {
    header("Location: ./us_pembuatan_dok.php?ntf=6");  
  }
}
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Kode</label>
                        <input type="text" class="form-control" name="kode" value="DOKPEM<?php echo kdauto("tb_ppd",""); ?>" readonly>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="dokumen" value="Pembuatan">
                  ...
                  <div class="row">
                   <div class="col-sm-12" align="center" style="background-color: #c1c1c1; border-color: black">
                    <br>
                    <h4 style="color: black"><b>Usulan Pembuatan Dokumen</b></h4>
                  </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="pem_dokumen" placeholder="Dokumen ..." required="required">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Judul<font style="color: red">*</font></label>
                      <input type="text" class="form-control" name="pem_judul" placeholder="Judul ..." required="required">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <div class="card-header">
              <button class="btn bg-primary" data-toggle="modal" data-target="#modal-add" title="Tambah Nota Intern"><i class="nav-icon far fa-plus-square"></i> Pembuatan Dokumen
              </button>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered second" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_ppd WHERE username='$datax' AND dokumen='Pembuatan' AND publish is NULL AND hapus is NULL ORDER BY id_peru DESC");
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        if ($row['status_pengecekan']=='New') {
                          ...
                          echo "<td>
                          <a href='sis_tampilan_revisi_pembuatan.php?id=$row[id_peru]' target=_blank title='Revisi'><button class='btn btn-dark btn-sm'>Revisi</button></a>
                          </td>";                                                      
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                      <label>Dokumen</label>
                                      <input type="text" class="form-control" name="pem_dokumen" placeholder="Dokumen ..." value="<?php echo $row['pem_dokumen']; ?>">
                                    </div>
                                  </div>
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                      <label>Judul</label>
                                      <input type="text" class="form-control" name="pem_judul" placeholder="Judul ..." value="<?php echo $row['pem_judul']; ?>">
                                    </div>
                                  </div>
                                </div>
                              </div>
