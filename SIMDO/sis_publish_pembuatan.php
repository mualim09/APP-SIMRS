                            ...
                            <div class="modal-body">
                              <form method="post" action="">
                                <div class="form-group">
                                  ...
                                  <input type="hidden" name="pem_dokumen" class="form-control" value="<?php echo $row['pem_dokumen'];?>" required>
                                  <input type="hidden" name="pem_judul" class="form-control" value="<?php echo $row['pem_judul'];?>" required>
