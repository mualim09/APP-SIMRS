...
// CODE 4 : RECORD HAS BEEN UPDATED
	...
	<div class="alert alert-success alert-dismissible" role="alert">
		...
		<br>
		Selamat Datang di Aplikasi Manajemen Dokumen Akreditasi RS. Khusus Ginjal Ny. R.A. Habibie. Enjoyed!
	</div>
	<?php
} elseif ($ntf == 121) {
	?>
	<div class="alert alert-success alert-dismissible" role="alert">
		...
		<br>
		Terimakasih telah memberi Kritik & Saran pada Aplikasi ITicket. Enjoyed!
	</div>
	<?php
} elseif ($ntf == 400) {
	?>
	<div class="alert alert-success alert-dismissible" role="alert">
		...
		<br>
		Status Publish Dokumen Berhasil Di Tarik!
	</div>
	<?php
} elseif ($ntf == 401) {
	?>
	...
	<div class="alert alert-success alert-dismissible" role="alert">
		...
		<br>
		Dokumen Berhasil Di Non-Aktifkan
	</div>
	<?php
}
?>