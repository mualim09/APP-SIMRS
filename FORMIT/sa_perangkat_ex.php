                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $result = mysqli_query($con,"SELECT a.id_perangkat,
                                            									...
                                            									ON a.id_perangkat=b.id_perangkat ORDER BY a.id_perangkat ASC");
                                            if(mysqli_num_rows($result)>0){
	                                            ...
	                                            if(mysqli_num_rows($result)>0){
	                                                while($row = mysqli_fetch_array($result))
	                                                {
                                                    echo "<div class='modal fade' id=".viewperangkat$row['id_perangkat']." role='dialog'>";
                                                      echo "<div class='modal-dialog'>";
                                                        echo "<div class='modal-content'>";
                                                          echo "<div class='modal-header'>";
                                                            echo "<label class='modal-title'>Spesifikasi Perangkat <b>".$row['kode_unit']."". $row['no_perangkat']."</b></label>";
                                                          ...
                                                          echo "<div class='modal-body'>";
                                                              echo "<div class='form-group'>";
                                                                echo "<h6>ID : <b><u>". $row['id_perangkat']."</u></b></h6>";
                                                                echo "<h6>No. Perangkat : <b><u>". $row['kode_unit']."". $row['no_perangkat']."</u></b></h6>";
                                                                echo "<h6>S/N : <b><u>". $row['sn']."</u></b></h6>";
                                                                echo "<h6>IP Address: <b><u>".$row['ip_address']."</u></b></h6>";
                                                                echo "<h6>OS: <b><u>".$row['os']."</u></b></h6>";
                                                                echo "<h6>RAM : <b><u>".$row['RAM']."</u></b></h6>";
                                                                echo "<h6>Merek : <b><u>".$row['merek']."</u></b></h6>";
                                                                echo "<h6>Tanggal Beli : <b><u>".$row['date_beli']."</u></b></h6>";
                                                                echo "<h6>Remark : <b><u>".$row['remark']."</u></b></h6>";
                                                              echo "</div>";
                                                              echo "<hr>";
                                                              echo "<div class='form-group'>";
                                                                echo "<h6>ID Device : <b><u>".$row['id_device']."</u></b></h6>";
                                                                echo "<h6>Nama Device : <b><u>".$row['nama_device']."</u></b></h6>";
                                                                echo "<h6>Jenis Device : <b><u>".$row['jenis_device']."</u></b></h6>";
                                                                echo "<h6>Tanggal Beli : <b><u>".$row['date_device']."</u></b></h6>";
                                                                echo "<h6>Merek : <b><u>".$row['merek']."</u></b></h6>";
                                                                echo "<h6>Remark : <b><u>".$row['remark_device']."</u></b></h6>";
                                                              echo "</div>";
                                                              echo "<button type='button' class='btn btn-warning btn-block btn-flat' data-dismiss='modal'>No</button>";
                                                          echo "</div>";
                                                        echo "</div>";
                                                      echo "</div>";
                                                    echo "</div>";
