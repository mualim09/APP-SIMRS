...
{    
  ...
  if ($query) {
    ...
    header("Location: ./agenda-surat-masuk.php?ntf=6");
  }
}
...
{    
  ...
  $query = mysql_query("UPDATE tb_asm SET 
    ...
    WHERE id_asm ='$id_asm'");
  if($query){
    header("Location: ./agenda-surat-masuk.php?ntf=4");                                                  
  } else {
...
{    
  ...
  $query = mysql_query("UPDATE tb_asm SET 
    ...
    WHERE id_asm ='$id_asm'");
  if($query){
    header("Location: ./agenda-surat-masuk.php?ntf=5");                                                  
  } else {
    header("Location: ./agenda-surat-masuk.php?ntf=6");  
  }
} 
      ...
      <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="berkas_asm" placeholder="No Berkas ..." required="required">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label>Alamat Pengirim<font style="color: red">*</font></label>
                          <textarea class="form-control" rows="3" name="alamat_pengirim" placeholder="Alamat Pengirim ..." required="required"></textarea>
                        </div>
                      </div>
                    </div>
                    <div align="center" style="background-color: gray">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="perihal_asm" placeholder="Perihal ..." required="required">
                        </div>
                      </div>
                    </div>
                    <div class="row">
          ...
          <div class="card">
            <div class="card-header">
              <div align="right">
                <a href="cetak-surat-masuk.php" target="_blank">
                  <span type="submit" name="search" value="search" class="btn bg-gray btn-flat">
                    <i class="fa fa-print"></i> 
                    Print
                  </span>
                </a>
                <a href="assets/file/surat_masuk/download/ex_surat-masuk.php">
                  ...
                  <tbody>
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        <a href='#' data-toggle='modal' data-target='#edit$row[id_asm]' title='Edit'><span class='btn btn-warning btn-xs'><i class='fa fa-edit'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#delete$row[id_asm]' title='Delete'><span class='btn btn-danger btn-xs'><i class='fas fa-times'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#addfile$row[id_asm]' title='Tambah Lampiran'><span class='btn btn-default btn-xs'><i class='fas fa-file'></i> </span></a>
                        </td>";
                        echo "</tr>";
                        ?>
                              ...
                              <div class="modal-body">
                                <form method="post" action="">
                                  <div class="form-group">
                                    ...
                                    <h6>Nomor Berkas : <b><u><?php echo $row['berkas_asm'];?></u></b></h6>
                                    <h6>Alamat Pengirim : <b><u><?php echo $row['alamat_pengirim'];?></u></b></h6>
