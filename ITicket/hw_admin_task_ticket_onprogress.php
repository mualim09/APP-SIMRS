...
if(isset($_POST["ticketonprogress"]))    
{
	...
	if($query){
		header("Location: ./hw_admin_task_ticket_onprogress.php?ntf=64");                                                  
	} else {
...
if(isset($_POST["ticketdone"]))    
{
	...
	$query .= mysql_query("UPDATE tb_ticket_his SET 
		...
		WHERE his_id ='$id_tick'");
	if($query){
		header("Location: ./hw_admin_task_ticket_onprogress.php?ntf=62");                                                  
	} else {
		echo "Updated Failed - Please contact your Administrator";
	}
...
if(isset($_POST["ticketfwsw"]))    
{
	...
	if($query){
		header("Location: ./hw_admin_task_ticket_onprogress.php?ntf=1001");                                                  
	} else {
		echo "Updated Failed - Please contact your Administrator";
	}
								...
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered second" style="width:100%">
										...
										<tbody>
											...
											$result = mysqli_query($con,"SELECT * FROM tb_ticket WHERE trouble='Hardware' AND progress='On Progress' ORDER BY id_tick DESC");
																...
																<div class="modal-body">
																	<form method="post" action="">
																		<div class="form-group">
																			...
																			<input type="hidden" name="id_tick" class="form-control" value="<?php echo $row['id_tick'];?>" required>
																			<!-- Yang Diupdate -->
																			<input type="hidden" name="admin_assign" class="form-control" value="eurapermanarskg@gmail.com" required>
