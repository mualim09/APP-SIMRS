...
// $dashboard_sw = mysql_query("SELECT COUNT(*) AS total_sw FROM tb_ticket WHERE trouble='Printer' AND email_user='dataxs'");
// $dashboard_hw = mysql_query("SELECT COUNT(*) AS total_hw FROM tb_ticket WHERE trouble='Printer' AND email_user='dataxs'");
								...
								<div class="card-body">
									<div class="d-inline-block">
										...
										<?php
											...
											$result = mysqli_query($con,"SELECT COUNT(*) AS total_sw FROM tb_ticket WHERE trouble='Printer' AND admin_assign='$datax' ORDER BY id_tick DESC");
								...
								<div class="card-body">
									<div class="d-inline-block">
										...
										<?php
											...
											$datax = $_SESSION['username'];
											$result = mysqli_query($con,"SELECT COUNT(*) AS total_hw FROM tb_ticket WHERE trouble='Printer' AND progress='New' AND admin_assign='$datax' ORDER BY id_tick DESC");
								...
								<div class="card-body">
									<div class="d-inline-block">
										<h5 class="text-muted">On Progress</h5>
											...
											$datax = $_SESSION['username'];
											$result = mysqli_query($con,"SELECT COUNT(*) AS total_hw FROM tb_ticket WHERE trouble='Printer' AND progress='On Progress' AND admin_assign='$datax' ORDER BY id_tick DESC");
								...
								<div class="card-body">
									<div class="d-inline-block">
										<h5 class="text-muted">Done</h5>
											...
											$datax = $_SESSION['username'];
											$result = mysqli_query($con,"SELECT COUNT(*) AS total_pti FROM tb_ticket WHERE trouble='Printer' AND progress='Done' AND admin_assign='$datax' ORDER BY id_tick DESC");
								...
								<div class="table-responsive">
									<table class="table no-wrap p-table">
										...
										<tbody>
											...
											$datax = $_SESSION['username'];
											$result = mysqli_query($con,"SELECT * FROM tb_ticket WHERE trouble='Printer' AND progress='New' AND admin_assign='$datax' ORDER BY id_tick DESC");
								...
								<div class="table-responsive">
									<table class="table no-wrap p-table">
										...
										<?php
											...
											$datax = $_SESSION['username'];
											$result = mysqli_query($con,"SELECT * FROM tb_ticket WHERE trouble='Printer' AND progress='On Progress' AND admin_assign='$datax' ORDER BY id_tick DESC");
								...
								<div class="table-responsive">
									<table class="table no-wrap p-table">
										...
										<tbody>
											...
											$datax = $_SESSION['username'];
											$result = mysqli_query($con,"SELECT * FROM tb_ticket WHERE trouble='Printer' AND progress='Done' AND admin_assign='$datax' ORDER BY id_tick DESC");
