	...
	<section class="categories_area clearfix" id="about">
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".3s">
						<img src="assets/img/all-rs/logo/sismadak1.png" alt="">
						<div class="catagory-title">
							<a href="http://rskghabibie.com:616/" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/img/rskgcare-icon/back-ok/hfis.png" alt="">
						<div class="catagory-title">
							<a href="https://hfis.bpjs-kesehatan.go.id/hfis/login" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/CARE/SITB.PNG" alt="">
						<div class="catagory-title">
							<a href="http://sitb.id/sitb/app" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/CARE/SIHA.PNG" alt="">
						<div class="catagory-title">
							<a href="http://siharskg.hospital/index.php" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/CARE/SIIP.PNG" alt="">
						<div class="catagory-title">
							<a href="https://sipp.bpjs-kesehatan.go.id/sipp/#/access/signin" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/CARE/rsonline.PNG" alt="">
						<div class="catagory-title">
							<a href="http://sirs.yankes.kemkes.go.id/fo/" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/CARE/SIR6.PNG" alt="">
						<div class="catagory-title">
							<a href="http://sirs.yankes.kemkes.go.id/sirs/login.php" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
						<img src="assets/CARE/PRB.PNG" alt="">
						<div class="catagory-title">
							<a href="http://bit.ly/FormPRBBandung" target="_blank">
								<h5>Open</h5>
							</a>
						</div>
					</div>
