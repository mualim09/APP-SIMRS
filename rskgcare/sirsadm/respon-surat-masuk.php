...
{    
  ...
  $date_rtsm     = $_POST['date_rtsm'];

  $nama = $_FILES['lampiran']['name'];
  $file_tmp = $_FILES['lampiran']['tmp_name'];

  move_uploaded_file($file_tmp, './assets/file/respon_time/surat_masuk/lampiran/'.$nama);

  $query = mysql_query("INSERT INTO tb_rtsm 
    (id_rtsm,tanggal,no_berkas,jam,mutasi,penerima,date_rtsm,lampiran) 
    VALUES 
    ('','$tanggal','$no_berkas','$jam','$mutasi','$json_penerima','$date_rtsm','$nama')
    ");
  if ($query) {
    header("Location: ./respon-surat-masuk.php?ntf=1");  
  } else {
    header("Location: ./respon-surat-masuk.php?ntf=6");
  }
}
...
{    
  ...
  $query = mysql_query("UPDATE tb_rtsm SET 
    tanggal ='$tanggal',
    no_berkas = '$no_berkas',
    jam = '$jam',
    mutasi = '$mutasi',
    ...
    date_rtsm = '$date_rtsm'
    WHERE id_rtsm ='$id_rtsm'");
  if($query){
    header("Location: ./respon-surat-masuk.php?ntf=4");                                                  
  } else {
...
{    
  ...
  $query = mysql_query("UPDATE tb_rtsm SET 
    ...
    WHERE id_rtsm ='$id_rtsm'");
  if($query){
    header("Location: ./respon-surat-masuk.php?ntf=5");                                                  
  } else {
    header("Location: ./respon-surat-masuk.php?ntf=6");  
  }
} 
...
if(isset($_POST['delete']))
{
  ...
  if($id_rtsm){
    $query = mysql_query("DELETE FROM tb_rtsm WHERE id_rtsm = '$id_rtsm'");
    if($query){
     header("Location: ./respon-surat-masuk.php?ntf=3");                     
   } else {
    header("Location: ./respon-surat-masuk.php?ntf=6");  
  }
} else {
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Respon Time Surat Masuk</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Respon Time Surat Masuk</a></li>
      ...
      <section class="content">
        <div class="container-fluid">
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <label class="modal-title">Tambah Respon Time Surat Masuk</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="hidden" class="form-control" name="id_rtsm">
                          <input type="hidden" class="form-control" name="date_rtsm" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
          ...
          <div class="card">
            <div class="card-header">
              <div align="right">
                <a href="cetak-respon-masuk.php" target="_blank">
                  <span type="submit" name="search" value="search" class="btn bg-gray btn-flat">
                    <i class="fa fa-print"></i> 
                    Print
                  </span>
                </a>
                <a href="assets/file/respon_time/surat_masuk/download/ex_surat-masuk.php">
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        if ($row['lampiran']==NULL){
                          ...
                          echo "<td align= ''>
                          <a href='assets/file/respon_time/surat_masuk/lampiran/$row[lampiran]' target='_blank' title='Lihat'><span class='btn btn-info btn-xs'><i class='fa fa-eye'></i> Lihat</span></a>
                          </td>";
                        }
                        echo "<td align= '' width='30px'>
                        <a href='#' data-toggle='modal' data-target='#edit$row[id_rtsm]' title='Edit'><span class='btn btn-warning btn-xs'><i class='fa fa-edit'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#delete$row[id_rtsm]' title='Delete'><span class='btn btn-danger btn-xs'><i class='fas fa-times'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#addfile$row[id_rtsm]' title='Tambah Lampiran'><span class='btn btn-default btn-xs'><i class='fas fa-file'></i> </span></a>
                        </td>";
                        echo "</tr>";
                        ?>

                        <!-- UPDATE -->
                        <div class="modal fade" id="edit<?php echo $row['id_rtsm'];?>">
                          <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title">Update Respon Time Surat Masuk</label>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="id_rtsm" value="<?php echo $row['id_rtsm']; ?>">
                                        <input type="hidden" class="form-control" name="date_rtsm"value="<?php echo $row['date_rtsm']; ?>">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row">
                        ...
                        <!-- DELETE -->
                        <div class="modal fade" id="delete<?php echo $row['id_rtsm'];?>" role="dialog">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title">Delete Respon Time Surat Masuk</label>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                <form method="post" action="">
                                  <div class="form-group">
                                    <label>Hapus Data Respon Time Surat Masuk?</label>
                                    ...
                                    <input type="hidden" name="id_rtsm" class="form-control" placeholder="client name" value="<?php echo $row['id_rtsm'];?>" required>
                                  </div>
                        ...
                        <!-- ADD FILE -->
                        <div class="modal fade" id="addfile<?php echo $row['id_rtsm'];?>" role="dialog">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
