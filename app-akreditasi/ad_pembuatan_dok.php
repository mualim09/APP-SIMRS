...
{    
  ...
  $nama = $_FILES['file_result']['name'];
  $file_tmp = $_FILES['file_result']['tmp_name'];

  move_uploaded_file($file_tmp, './assets/file/pembuatan/admin/'.$nama);
  ...
  $query .= mysql_query("UPDATE tb_ppd_his SET 
    his_file_result = '$nama',
    his_status_pengecekan = '$status_pengecekan'
    WHERE id_his = '$id_peru'");
  if($query){
    header("Location: ./ad_pembuatan_dok.php?ntf=5");                                                  
  } else {
    header("Location: ./ad_pembuatan_dok.php?ntf=6");  
  }
} 

// PUBLISH
if(isset($_POST["dokpublish"]))    
{    
  $id_peru           = $_POST['id_peru'];
  ...
  $pem_dokumen       = $_POST['pem_dokumen'];
  $pem_judul         = $_POST['pem_judul'];
  $kode              = $_POST['kode'];
  ...
  $query .= mysql_query("INSERT INTO tb_notif 
    ...
    VALUES 
    ('','$username','$pem_dokumen','$pem_judul','$kode','$date_verify')
    "); 
  if($query){
    header("Location: ./ad_pembuatan_dok.php?ntf=401");                                                  
  } else {
    echo "Updated Failed - Please contact your Administrator";
  }
} 
          ...
          <div class="page-header">
            ...
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php?ntf=0" class="breadcrumb-link">From</a></li>
              ...
              <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered second" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_ppd WHERE dokumen='Pembuatan' AND publish is NULL AND hapus is NULL ORDER BY id_peru DESC");
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        if ($row['pem_no_dok']==NULL){
                          ...
                          echo "<td>
                          <a href='#' data-toggle='modal' data-target='#updatenodok$row[id_peru]' title='Input No. Dokumen'><span class='btn btn-dark btn-sm'><i class='fas fa-check'></i> </span></a>
                          </td>";
                        }
                        if ($row['status_pengecekan']=='New') {
                          ...
                          echo "<td>
                          <a href='sis_tampilan_revisi_pembuatan.php?id=$row[id_peru]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'>Revisi</button></a>
                          </td>";                                                      
                        }elseif ($row['status_pengecekan']=='Disetujui') {
                          echo "<td>
                          <a href='sis_tampilan_revisi_pembuatan.php?id=$row[id_peru]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'><i class='fa fas fa-check' title='Disetujui'></i></button></a>
                          </td>";    
                        }
                        echo "<td>
                      ...
                      if ($row['pem_no_dok']==NULL) {
                        echo "<td>
                        <a href='#' data-toggle='modal' data-target='#revisi$row[id_peru]' title='Revisi'><span class='btn btn-dark btn-sm'><i class='fa fas fa-list-alt'></i> </span></a>
                        </td>";
                      }else{
                        echo "<td>
                        <a href='#' data-toggle='modal' data-target='#addfile$row[id_peru]' title='Tambah Lampiran'><span class='btn btn-dark btn-sm'><i class='fas fa-file'></i> </span></a>
                        <a href='#' data-toggle='modal' data-target='#revisi$row[id_peru]' title='Revisi'><span class='btn btn-dark btn-sm'><i class='fa fas fa-list-alt'></i> </span></a>
                        </td>";
                      }
                      if ($row['file_result']==NULL) {
                       ...
                       echo "<td>
                       <a href='#' data-toggle='modal' data-target='#publish$row[id_peru]' title='Publish Dokumen'><span class='btn btn-dark btn-sm'><i class='fas fa-globe'></i> </span></a>
                       </td>"; 
                     }
                     echo "</tr>";
                     ?>
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="form-group">
                                    ...
                                    <h5><b>Dokumen :</b> <?php echo $row['pem_dokumen'];?></h5>
                                    <h5><b>Judul :</b> <?php echo $row['pem_judul'];?></h5>
                                    <h5><b>No. Dokumen :</b> 
                                      <?php
                                      if ($row['pem_no_dok']==NULL) {
                                    ...
                                    if ($row['upload_lam']==NULL){
                                      ...
                                      echo "
                                      <div align='center'>
                                      <a href='./assets/file/pembuatan/user/$row[upload_lam]' target='_blank'><img src='assets/images/icon/file.png' width='90px'></a>
                                      </div>
                                      ";
                                    }
                                    ?>
                      ...
                      <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                          ...
                          <form action="" method="POST">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                <button type="submit" name="revisi" class="btn btn-block btn-primary">Kirim</button>
                                <button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Tutup</button>
                              </div>
                            </div>
                          </form>
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" name="status_pengecekan" class="form-control" value="Disetujui">
                                  </div>
                                </div>
                              </div>
                    ...
                    <!-- PUBLISH -->
                    <div class="modal fade" id="publish<?php echo $row['id_peru'];?>" role="dialog">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <form method="post" action="">
                              <div class="form-group">
                                ...
                                if ($row['file_result']==NULL){
                                  ...
                                  echo "
                                  <div align='center'>
                                  <a href='./assets/file/pembuatan/admin/$row[file_result]' target='_blank'><img src='assets/images/icon/file.png' width='90px'></a>
                                  </div>
                                  ";
                                }
                                ?>
                                ...
                                <input type="hidden" name="pem_dokumen" class="form-control" value="Dokumen: <?php echo $row['pem_dokumen'];?>" required>
                                <input type="hidden" name="pem_judul" class="form-control" value="Judul: <?php echo $row['pem_judul'];?>" required>
                                <input type="hidden" name="kode" class="form-control" value="<?php echo $row['kode'];?>" required>
                                <!-- END NOTIF -->
                              ...
                              <div class="form-group">
                                <button type="submit" name="dokpublish" class="btn btn-success btn-block btn-flat">Publish</button>
                                <button type="button" class="btn btn-warning btn-block btn-flat" data-dismiss="modal">Tutup</button>
                              </div>
                            </form>
                          </div>
