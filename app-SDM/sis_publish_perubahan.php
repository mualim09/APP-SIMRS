...
<head>
  ...
  <title>SIMDO | Publish Perubahan Dokumen</title>
                    ...
                    if(mysqli_num_rows($result)>0){
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        if ($row['status_pengecekan']=='New') {
                          ...
                          echo "<td>
                          <a href='tampilan_revisi_perubahan.php?id=$row[id_peru]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'>Revisi</button></a>
                          </td>";                                                      
                        }elseif ($row['status_pengecekan']=='Disetujui') {
                          echo "<td>
                          <a href='tampilan_revisi_perubahan.php?id=$row[id_peru]' target=_blank title='Template WP'><button class='btn btn-dark btn-sm'><i class='fa fas fa-check' title='Disetujui'></i></button></a>
                          </td>";    
                        }
                        echo "<td>
                            ...
                            <div class="modal-body">
                              <form method="post" action="">
                                <div class="form-group">
                                  ...
                                  <input type="hidden" name="peru_dokumen" class="form-control" value="<?php echo $row['peru_dokumen'];?>" required>
                                  <input type="hidden" name="peru_judul" class="form-control" value="<?php echo $row['peru_judul'];?>" required>
