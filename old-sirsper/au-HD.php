              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="breadcomb-wp">
                  ...
                  <div class="breadcomb-ctn">
                    <h2>Form Audit Hemodialisa</h2>
                    <p>Dashboard / Hemodialisa</p>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td colspan="4" align="center">
                          <p>
                            ...
                            <input type="hidden" class="form-control" name="ruangan" value="Hemodialisa">
                      ...
                      <tr>
                        <td colspan="6" align="center" style="background-color: #00c292; color: #ffff">
                          <p><h3>Monitoring/ Audit PPI di Ruang Hemodialisa</h3></p>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
