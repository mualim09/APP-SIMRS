                    ...
                    <div class="form-group">
                      <div align="center">
                        ...
                        if ($this->session->userdata("foto")==NULL) { ?>
                          <img src="<?php echo base_url('assets/admin/assets/images/user/avatar.png')?>" alt="AdminLTE Logo" class="lingkaran">   
                        <?php }else{ ?>
                          <img src="<?php echo base_url().'assets/admin/assets/images/user/'. $this->session->userdata("foto");?>" alt="AdminLTE Logo" class="lingkaran">   
                        <?php } ?>
                      </div>
                      <hr>
                  ...
                  <div class="row">
                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
                      <div class="text-center">
                        <?php
                        if ($this->session->userdata("foto")==NULL) { ?>
                          <img src="<?php echo base_url('assets/admin/assets/images/user/avatar.png')?>" alt="AdminLTE Logo" class="rounded-circle user-avatar-xxl">   
                        <?php }else{ ?>
                          <img src="<?php echo base_url().'assets/admin/assets/images/user/'. $this->session->userdata("foto");?>" alt="AdminLTE Logo" class="rounded-circle user-avatar-xxl">   
                        <?php } ?>
                      </div>
                    </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card" id="headings">
              ...
              <div class="card-body">
                ...
                <br>
                <p align="center"><img src="<?php echo base_url('assets/admin/assets/img/all-rs/rskgcare.png')?>" width="500px"></p>
              </div>
            </div>
          </div>
        </div>
