  ...
  <div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">Report Ticket Page</h2>
            ...
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Report Ticket Page</li>
                </ol>
              </nav>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <h5 class="card-header">Cari berdasarkan tanggal</h5>
            <div class="card-body">
              <form action="" method="POST">
                <div class="input-group margin">
                  <input type="date" class="form-control">
                  <span class="input-group-btn">
                    <button class="btn btn-dark btn-flat" type="button"><i class="fa fa-search"></i> Sreach</button>
                  </span>
                </div>
              </form>
            </div>
              ...
              <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered second" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_ticket_his WHERE his_trouble='Software' ORDER BY his_id DESC");
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form method="post" action="">
                                  ...
                                  <hr>
                                  <div class="form-group">
                                    <h6><u>Remark :</u> <br><?php echo $row['his_remark_it'];?></h6>
                                  </div> 
                                  <div class="form-group">
                                    <h6><u>Lampiran :</u></h6>
                                    <div align="center">
                                      <?php
                                      if ($row['his_remark_file']==NULL) {
                                        echo"<label>Tidak ada file</label>";
                                      }else{
                                        echo"<span class='responsive'><img src='assets/lampiran/$row[his_remark_file]' class='iklan'></span>";
                                      }
                                      ?>
                                    </div>
                                  </div>
