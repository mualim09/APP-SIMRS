...
if(isset($_POST["ticketonprogress"]))    
{
	...
	if($query){
		header("Location: ./pr_admin_task_ticket_done.php?ntf=64");                                                  
	} else {
...
if(isset($_POST["ticketdone"]))    
{
	...
	$query .= mysql_query("UPDATE tb_ticket_his SET 
		...
		WHERE his_id ='$id_tick'");
	if($query){
		header("Location: ./pr_admin_task_ticket_done.php?ntf=62");                                                  
	} else {
		echo "Updated Failed - Please contact your Administrator";
	}
...
if(isset($_POST["ticketfwsw"]))    
{
	...
	if($query){
		header("Location: ./pr_admin_task_ticket_done.php?ntf=1001");                                                  
	} else {
		echo "Updated Failed - Please contact your Administrator";
	}
								...
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered second" style="width:100%">
										...
										<tbody>
											...
											$result = mysqli_query($con,"SELECT * FROM tb_ticket WHERE trouble='Hardware' AND progress='Done' ORDER BY id_tick DESC");
